...
async function main() {
  const keywords = [
    ...
    "BEARER_TOKEN", "AUTH_TOKEN", "CREDENTIALS", "TOKEN", "PASSWORD_HASH", 
    "ENCRYPTION_KEY", "CLIENT_SECRET", "SECRET_TOKEN", "APP_SECRET", "JWT_SECRET",
    "OAUTH_TOKEN", "FTP_PASSWORD", "FTP_USER", "SFTP_PASSWORD", "SFTP_USER", 
    "SSH_KEY", "SSH_PRIVATE_KEY", "CLOUD_SECRET", "AUTH_KEY", "AUTH_SECRET", 
    "REDIS_PASSWORD", "POSTGRES_PASSWORD", "MONGO_PASSWORD", "ELASTIC_PASSWORD", 
    "API_TOKEN", "API_PRIVATE_KEY", "TWILIO_API_KEY", "SENDGRID_API_KEY", 
    "GOOGLE_API_KEY", "HEROKU_API_KEY", "SLACK_TOKEN", "SLACK_WEBHOOK_URL",
    "GITHUB_TOKEN", "BITBUCKET_TOKEN", "GITLAB_TOKEN", "GITHUB_CLIENT_ID", 
    "GITHUB_CLIENT_SECRET", "DOCKER_PASSWORD", "DOCKER_TOKEN"
];
